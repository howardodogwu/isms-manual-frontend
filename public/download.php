...
$html = "
    ...
    <body>
        <div class='cover'>
            <h1 style='font-size: 36px; margin-bottom: 20px;'>ISMS Manual</h1>
            <h2 style='font-size: 24px; color: #5521B5; margin-bottom: 30px;'>ISO 27001:2022</h2>
            <p style='font-size: 18px; margin-bottom: 10px;'>Prepared for: <strong>" . ($answers['company_name'] ?? 'The Organization') . "</strong></p>
            <p style='font-size: 14px; color: #666; margin-bottom: 40px;'>Date: " . date("Y-m-d") . "</p>
            <p style='font-size: 12px; color: #999; margin-top: 100px;'>Generated by PurpleWasp</p>
        </div>
